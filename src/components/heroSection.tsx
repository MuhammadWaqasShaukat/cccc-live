  ...
  return (
    <div className="   h-screen w-screen relative bg-hero-section-upper bg-no-repeat bg-cover flex flex-col overflow-clip">
      ...
      <div className="relative md:static top-[75%] md:top-auto">
        ...
        <div className="bg-hero-section-frog max-w-[211px] max-h-[230px] h-[17%] w-[15.7%] min-h-[69px] min-w-[61px] bg-contain bg-no-repeat z-10 absolute lg:bottom-[56%] md:bottom-[53%]  bottom-[12rem] left-0  bg-left-bottom"></div>
      ...
      <div className="relative md:static top-[75%] md:top-auto">
        ...
        <div className="bg-hero-section-memcoin-4 max-w-[199px] maxh-[229px] min-w-[71px] w-[15%] h-[17%] min-h-[82px] bg-contain bg-no-repeat z-10 absolute md:top-[32%] bottom-[11.5rem] right-0 bg-right-bottom"></div>
