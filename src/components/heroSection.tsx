...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col w-screen h-screen bg-no-repeat bg-cover bg-hero-section-upper md:overflow-clip">
      <TopBar />
      ...
      <div className="block relative md:static top-[75%] md:top-auto">
        <div className=" bg-hero-section-castle-red-1 max-w-[344px] max-h-[475px] min-h-[181px] w-[30%] h-[35.24%] min-w-[134px] bg-contain bg-no-repeat absolute z-[1] md:bottom-[42%] lg:bottom-[50%]  bottom-[11rem] bg-left-bottom  md:left-0"></div>
        <motion.div
          initial={{ y: 20 }}
          whileHover={{ y: -20 }}
          transition={{
        ...
        <div className="bg-hero-section-chillguy lg:w-[352px] max-h-[341px] h-[25.30%] w-[26%] min-w-[117px] min-h-[111px] bg-contain z-10 absolute md:top-[32%] lg:top-[24%] bottom-[10rem] md:left-[15%] lg:left-[6%] left-[4%] bg-bottom bg-no-repeat"></div>
        <div className=" max-w-[400px] max-h-[619px] min-w-[162px] min-h-[230px] h-[50%] w-[37%] absolute bottom-[12%] ">
          ...
          <div className=" bg-[#1e1e1e] -mt-1 bg-left-bottom md:w-[65%] w-[60%] lg:w-[62.2%] md:h-[65%] lg:h-[70%] sm:w-[50%] h-[70%]   bg-contain bg-no-repeat absolute bottom-0 z-10"></div>
        </div>
        <div className="bg-hero-section-memcoin-1 hidden md:block max-w-[273px] max-h-[319px] w-[20%] h-[24%] min-w-[70px] min-h-[78px] absolute lg:bottom-[11%]  md:bottom-[5%]  left-[0%] z-20 bg-contain bg-no-repeat"></div>
      </div>
      ...
      <div className=" absolute  object-contain w-[50%]  md:w-[50%]  sm:h-[80.48%] h-[30%] bottom-[6%] max-w-[500px] max-h-[600px] min-w-[200px] min-h-[176px] lg:-bottom-[10%]  md:-bottom-[20%] sm:-bottom-[26%] md:left-[10%] -left-[12%] z-30">
      ...
      <div className=" relative md:static top-[75%] md:top-auto">
        <div className="bg-hero-section-castle-blue-1 pointer-events-none max-w-[344px] max-h-[475px] min-h-[181px] w-[30%] h-[35.24%] min-w-[134px] bg-contain bg-no-repeat absolute z-0 md:bottom-[42%]  lg:bottom-[50%] bottom-[11rem] bg-right-bottom right-0"></div>
        <motion.div
          initial={{ y: 20 }}
          whileHover={{ y: -20 }}
          transition={{
        ...
        <div className="hidden md:block  md:w-[400px] md:h-[300px] w-[250px] origin-center  h-[200px] bg-no-repeat z-[31]  absolute  -bottom-[10%] lg:bottom-[1%] bg-bottom  lg:right-[10%] right-[0%]">
          <div className="relative flex flex-col items-center justify-end ">
            <div
