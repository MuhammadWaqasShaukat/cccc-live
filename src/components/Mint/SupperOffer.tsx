...
const SupperOffer = () => {
  ...
  return (
    <>
      {!viewSupperOffer ? (
        <button
          onClick={() => setViewSuperOffer(!viewSupperOffer)}
          className="bg-super-offer w-24 h-20 bg-contain bg-no-repeat mx-auto z-70 absolute top-20 lg:w-40 lg:h-28 md:w-32 md:h-24 left-16 md:left-1/2 -translate-x-1/2 md:-top-24"
        ></button>
      ) : (
        <Modal
              ...
              <div className="w-full flex flex-col gap-[25px] items-center">
                <div className="flex flex-row w-2/3 ml-auto justify-center">
                  <p className=" text-white lg:text-2xl md:text-base uppercase text-center font-patrick-hand-sc  tracking-widest px-4">
                    <span className="lg:text-3xl md:text-lg">9 NFT</span>s for
                    the price <br /> of
