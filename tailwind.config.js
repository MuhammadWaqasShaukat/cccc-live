  ...
  theme: {
    ...
    backgroundImage: {
      ...
      "about-section-castle-sm":
        "url('/images/section-about/castle.about.sm.png')",
      ...
      "mint-section-book-lg-1":
        "url('/images/section-mint/book-border-lg-1.png')",
      ...
      "hero-section-castle-red-1":
        "url('/images/section-hero/castle-red-top.png')",
      "hero-section-castle-red-2": "url('/images/section-hero/castle-red.png')",
      "hero-section-castle-blue-1":
        "url('/images/section-hero/castle-blue-top.png')",
      "hero-section-castle-blue-2":
        "url('/images/section-hero/castle-blue.png')",
      ...
      "bm-sm-mint": "url('/images/bookmarks/bm-sm-mint.png')",
      "bm-sm-nfts": "url('/images/bookmarks/bm-sm-nfts.png')",
      "bm-sm-eggs": "url('/images/bookmarks/bm-sm-eggs.png')",
      ...
      "how-it-works": "url('/images/how-it-works.png')",
      "how-it-works-arm": "url('/images/arm.png')",
